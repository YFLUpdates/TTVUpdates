...
export default async function commandWatchtime(
  ...
  if(["xspeedyq", "grubamruwa", "dobrycsgo", "mrdzinold", "xmerghani", "xkaleson", "neexcsgo", "banduracartel", "shavskyyy", "f1skacz", "petunia098", "tuszol"].includes(channelClean)) return null;
